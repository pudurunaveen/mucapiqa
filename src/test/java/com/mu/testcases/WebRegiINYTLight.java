...
public class WebRegiINYTLight {
	...
	@Test
	public void verifyLightTestItaly() {
		...
		ValidateData.validateGatewayCAPIData(actCapiData, this.getClass().getSimpleName(), ReadJsonData.MAG_TYPE_OF_SALE, ReadJsonData.LOCATION_LIGHT);
	...
	@Test
	public void verifyLightTestPortugal() {
	...
	@Test
	public void verifyLightTestGreece() {
	...
	@Test
	public void verifyLightTestSpain() {
