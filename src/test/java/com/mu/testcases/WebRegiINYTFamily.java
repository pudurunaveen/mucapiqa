...
public class WebRegiINYTFamily {
	...
	@Test
	public void verifyLightTestSweden() {
		...
		ValidateData.validateGatewayCAPIData(actCapiData, this.getClass().getSimpleName(), ReadJsonData.MAG_TYPE_OF_SALE, ReadJsonData.LOCATION_FAMILY);
	...
	@Test
	public void verifyLightTestFinland() {
	...
	@Test
	public void verifyLightTestNorway() {
	...
	@Test
	public void verifyLightTestDenmark() {
	...
	@Test
	public void verifyLightTestNetherlands() {
